...
def show_main_window():
    global tk, search_var, canvas, cards_frame
    tk = Tk()
    tk.title("Товары")
    tk.geometry("900x650")
    tk.config(bg="#F8F8F8")
